...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "Pods-PhoneUmbrellaFramework/Alamofire.framework"
  install_framework "Pods-PhoneUmbrellaFramework/AlamofireOauth2.framework"
  ...
  install_framework "Pods-PhoneUmbrellaFramework/JazzHands.framework"
  install_framework "Pods-PhoneUmbrellaFramework/KeychainAccess.framework"
